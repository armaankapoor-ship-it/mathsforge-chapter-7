# MathsForge Chapter 7 - Integrals

A separate, static Class 12 Mathematics learning website for **Chapter 7: Integrals**. It is frontend-only, so it can be shared publicly through GitHub Pages without paid hosting, paid APIs, databases, or subscriptions.

Public website:

```text
https://armaankapoor-ship-it.github.io/mathsforge-chapter-7/
```

GitHub repository:

```text
https://github.com/armaankapoor-ship-it/mathsforge-chapter-7
```

## What Is Included

- Topic notes for Integrals
- Formula sheet
...
2. Create a new public repository named `mathsforge-chapter-7`.
